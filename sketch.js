...
music.loop();
    ...
    box10 = new greenBox(550,210,40,40);
    box11 = new greenBox(590,210,40,40);
    box12 = new greenBox(635,210,40,40);
    box13 = new greenBox(675,210,40,40);
    box14 = new greenBox(720,210,40,40);
    

    box15 = new blackBox(675,200,40,40)
    box17 = new blackBox(635,200,40,40)
    box18 = new blackBox(590,200,40,40)

    box19 = new orangeBox(635,150,40,40)
